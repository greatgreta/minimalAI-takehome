// Writes docs/screens/configuration-empty.png (at load) and configuration-filled.png (after the whole
// script, snippet visible) at 1440x1024. Needs a running preview: npm run build && npm run preview.
...
await browser.close();
console.log('wrote docs/screens/configuration-empty.png and configuration-filled.png');
